...
event:
  ...
  if ((mode = 0) and (Par_41 = 1)) then  'Computer Controled switch
    ...
    p2_write_dac32(ModuleAout1, 0, (data_1[1]) or (shift_left(data_2[1], 16)))
    p2_write_dac32(ModuleAout2, 0, (data_9[1]) or (shift_left(data_10[1], 16)))
    p2_write_dac32(ModuleAout3, 0, (data_17[1]) or (shift_left(data_18[1], 16)))   
    'Setup the output values for channel 3 and 4 on all modules
    p2_write_dac32(ModuleAout1, 1, (data_3[1]) or (shift_left(data_4[1], 16)))
    p2_write_dac32(ModuleAout2, 1, (data_11[1]) or (shift_left(data_12[1], 16)))
    p2_write_dac32(ModuleAout3, 1, (data_19[1]) or (shift_left(data_20[1], 16)))   
    'Setup the output values for channel 5 and 6 on all modules
    p2_write_dac32(ModuleAout1, 2, (data_5[1]) or (shift_left(data_6[1], 16)))
    p2_write_dac32(ModuleAout2, 2, (data_13[1]) or (shift_left(data_14[1], 16)))
    p2_write_dac32(ModuleAout3, 2, (data_21[1]) or (shift_left(data_22[1], 16)))
    'Setup the output values for channel 7 and 8 on all modules
    p2_write_dac32(ModuleAout1, 3, (data_7[1]) or (shift_left(data_8[1], 16)))
    p2_write_dac32(ModuleAout2, 3, (data_15[1]) or (shift_left(data_16[1], 16)))
    p2_write_dac32(ModuleAout3, 3, (data_23[1]) or (shift_left(data_24[1], 16))) 
  endif
